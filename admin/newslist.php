...
class cnews_list extends cnews {
	...
	function __construct() {
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fnewslistsrch";
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->news_id->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == EW_ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ewAction ewListAction\" title=\"" . ew_HtmlEncode($caption) . "\" data-caption=\"" . ew_HtmlEncode($caption) . "\" href=\"\" onclick=\"ew_SubmitAction(event,jQuery.extend({f:document.fnewslist}," . $listaction->ToJson(TRUE) . "));return false;\">" . $icon . "</a>";
...
var CurrentForm = fnewslist = new ew_Form("fnewslist", "list");
...
<?php
	$bSelectLimit = $news_list->UseSelectLimit;
	if ($bSelectLimit) {
...
// Header row
$news_list->RowType = EW_ROWTYPE_HEADER;
...
<?php if ($news->news_id->Visible) { // news_id ?>
	<?php if ($news->SortUrl($news->news_id) == "") { ?>
		<th data-name="news_id"><div id="elh_news_news_id" class="news_news_id"><div class="ewTableHeaderCaption"><?php echo $news->news_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="news_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->news_id) ?>',1);"><div id="elh_news_news_id" class="news_news_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $news->news_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($news->news_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($news->news_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($news->news_date->Visible) { // news_date ?>
	<?php if ($news->SortUrl($news->news_date) == "") { ?>
		<th data-name="news_date"><div id="elh_news_news_date" class="news_news_date"><div class="ewTableHeaderCaption"><?php echo $news->news_date->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="news_date"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->news_date) ?>',1);"><div id="elh_news_news_date" class="news_news_date">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $news->news_date->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($news->news_date->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($news->news_date->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $news_list->RowCnt ?>_news_news_id" class="news_news_id">
...
<span id="el<?php echo $news_list->RowCnt ?>_news_news_date" class="news_news_date">
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $news_list->PageUrl() ?>start=<?php echo $news_list->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($news_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $news_list->PageUrl() ?>start=<?php echo $news_list->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $news_list->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($news_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $news_list->PageUrl() ?>start=<?php echo $news_list->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($news_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $news_list->PageUrl() ?>start=<?php echo $news_list->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>

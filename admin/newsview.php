...
<?php if ($news->news_id->Visible) { // news_id ?>
	<tr id="r_news_id">
		<td><span id="elh_news_news_id"><?php echo $news->news_id->FldCaption() ?></span></td>
...
<?php if ($news->news_title->Visible) { // news_title ?>
	<tr id="r_news_title">
		<td><span id="elh_news_news_title"><?php echo $news->news_title->FldCaption() ?></span></td>
		<td data-name="news_title"<?php echo $news->news_title->CellAttributes() ?>>
<span id="el_news_news_title">
<span<?php echo $news->news_title->ViewAttributes() ?>>
<?php echo $news->news_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($news->news_description->Visible) { // news_description ?>
	<tr id="r_news_description">
		<td><span id="elh_news_news_description"><?php echo $news->news_description->FldCaption() ?></span></td>
		<td data-name="news_description"<?php echo $news->news_description->CellAttributes() ?>>
<span id="el_news_news_description">
<span<?php echo $news->news_description->ViewAttributes() ?>>
<?php echo $news->news_description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

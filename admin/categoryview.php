...
$category_view = NULL; // Initialize page object first

class ccategory_view extends ccategory {
	...
	function SetupOtherOptions() {
		...
		// "detail_sub_category"
		$item = &$option->Add("detail_sub_category");
		$body = $Language->Phrase("ViewPageDetailLink") . $Language->TablePhrase("sub_category", "TblCaption");
		...
		$links = "";
		if ($GLOBALS["sub_category_grid"] && $GLOBALS["sub_category_grid"]->DetailView) {
		...
		if ($GLOBALS["sub_category_grid"] && $GLOBALS["sub_category_grid"]->DetailEdit) {
		...
		if ($GLOBALS["sub_category_grid"] && $GLOBALS["sub_category_grid"]->DetailAdd) {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("sub_category", $DetailTblVar)) {
				...
				if ($GLOBALS["sub_category_grid"]->DetailView) {
					$GLOBALS["sub_category_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($category_view)) $category_view = new ccategory_view();
...
var CurrentForm = fcategoryview = new ew_Form("fcategoryview", "view");

// Form_CustomValidate event
fcategoryview.Form_CustomValidate = 
...
fcategoryview.ValidateRequired = true;
<?php } else { ?>
fcategoryview.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="fcategoryview" id="fcategoryview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($category_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $category_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="category">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($category->category_id->Visible) { // category_id ?>
	<tr id="r_category_id">
		<td><span id="elh_category_category_id"><?php echo $category->category_id->FldCaption() ?></span></td>
...
<?php echo $category->category_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($category->category_name->Visible) { // category_name ?>
	<tr id="r_category_name">
		<td><span id="elh_category_category_name"><?php echo $category->category_name->FldCaption() ?></span></td>
...
<?php echo $category->category_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($category->category_description->Visible) { // category_description ?>
	<tr id="r_category_description">
		<td><span id="elh_category_category_description"><?php echo $category->category_description->FldCaption() ?></span></td>
		<td data-name="category_description"<?php echo $category->category_description->CellAttributes() ?>>
<span id="el_category_category_description">
<span<?php echo $category->category_description->ViewAttributes() ?>>
<?php echo $category->category_description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("sub_category", explode(",", $category->getCurrentDetailTable())) && $sub_category->DetailView) {
?>

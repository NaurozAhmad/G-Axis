...
class cproducts_add extends cproducts {
	...
	function LoadDefaultValues() {
		...
		$this->product_secimage->CurrentValue = NULL; // Clear file related field
		$this->product_description->CurrentValue = NULL;
		$this->product_description->OldValue = $this->product_description->CurrentValue;
		$this->feature_ledtype->CurrentValue = NULL;
		$this->feature_ledtype->OldValue = $this->feature_ledtype->CurrentValue;
		$this->feature_power->CurrentValue = NULL;
		$this->feature_power->OldValue = $this->feature_power->CurrentValue;
		$this->feature_lumen->CurrentValue = NULL;
		$this->feature_lumen->OldValue = $this->feature_lumen->CurrentValue;
		$this->feature_viewangle->CurrentValue = NULL;
		$this->feature_viewangle->OldValue = $this->feature_viewangle->CurrentValue;
		$this->feature_cri->CurrentValue = NULL;
		$this->feature_cri->OldValue = $this->feature_cri->CurrentValue;
		$this->feature_iprating->CurrentValue = NULL;
		$this->feature_iprating->OldValue = $this->feature_iprating->CurrentValue;
		$this->feature_colortemp->CurrentValue = NULL;
		$this->feature_colortemp->OldValue = $this->feature_colortemp->CurrentValue;
		$this->feature_body->CurrentValue = NULL;
		$this->feature_body->OldValue = $this->feature_body->CurrentValue;
		$this->feature_cutoutsize->CurrentValue = NULL;
		$this->feature_cutoutsize->OldValue = $this->feature_cutoutsize->CurrentValue;
		$this->feature_colors->CurrentValue = NULL;
		$this->feature_colors->OldValue = $this->feature_colors->CurrentValue;
		$this->feature_dimmable->CurrentValue = NULL;
		$this->feature_dimmable->OldValue = $this->feature_dimmable->CurrentValue;
		$this->feature_warranty->CurrentValue = NULL;
		$this->feature_warranty->OldValue = $this->feature_warranty->CurrentValue;
		$this->feature_application->CurrentValue = NULL;
		$this->feature_application->OldValue = $this->feature_application->CurrentValue;
	}
	...
	function RenderRow() {
		...
		$this->feature_application->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->product_secimage);
...
fproductsadd.ValidateRequired = true;
<?php } else { ?>
fproductsadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fproductsadd.Lists["x_category_id"] = {"LinkField":"x_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_category_name","","",""],"ParentFields":[],"ChildFields":["x_scat_id"],"FilterFields":[],"Options":[],"Template":""};
fproductsadd.Lists["x_scat_id"] = {"LinkField":"x_scat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_scat_name","","",""],"ParentFields":["x_category_id"],"ChildFields":[],"FilterFields":["x_category_id"],"Options":[],"Template":""};
...
<script type="text/javascript">
ew_CreateEditor("fproductsadd", "x_product_description", 35, 4, <?php echo ($products->product_description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>

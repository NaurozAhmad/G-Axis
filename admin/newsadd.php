...
class cnews_add extends cnews {
	...
	function LoadDefaultValues() {
		...
		$this->news_description->CurrentValue = NULL;
		$this->news_description->OldValue = $this->news_description->CurrentValue;
	}
...
<script type="text/javascript">
ew_CreateEditor("fnewsadd", "x_news_title", 35, 4, <?php echo ($news->news_title->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
ew_CreateEditor("fnewsadd", "x_news_description", 35, 4, <?php echo ($news->news_description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>

...
define("EW_PROJECT_NAME", "gaxis", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{C3CE8554-8FA2-42A1-89B9-3DB1F25B77B3}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '7Uvs774iuTJaV5vh', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/gaxis.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "gaxis", "qs" => "`", "qe" => "`");
...
define("EW_MAX_FILE_SIZE", 200000000, TRUE); // Max file size

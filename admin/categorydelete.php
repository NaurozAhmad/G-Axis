...
var CurrentForm = fcategorydelete = new ew_Form("fcategorydelete", "delete");
...
<?php if ($category->category_name->Visible) { // category_name ?>
		<th><span id="elh_category_category_name" class="category_category_name"><?php echo $category->category_name->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $category_delete->RowCnt ?>_category_category_name" class="category_category_name">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $category_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">

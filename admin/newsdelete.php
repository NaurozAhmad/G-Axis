...
<?php if ($news->news_id->Visible) { // news_id ?>
		<th><span id="elh_news_news_id" class="news_news_id"><?php echo $news->news_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($news->news_date->Visible) { // news_date ?>
		<th><span id="elh_news_news_date" class="news_news_date"><?php echo $news->news_date->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>

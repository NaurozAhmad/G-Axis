...
$sub_category_view = NULL; // Initialize page object first

class csub_category_view extends csub_category {
	...
	// Page object name
	var $PageObjName = 'sub_category_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["scat_id"] <> "") {
				...
				$this->RecKey["scat_id"] = $this->scat_id->QueryStringValue;
			} elseif (@$_POST["scat_id"] <> "") {
				$this->scat_id->setFormValue($_POST["scat_id"]);
				$this->RecKey["scat_id"] = $this->scat_id->FormValue;
			} else {
				$sReturnUrl = "sub_categorylist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "sub_categorylist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "sub_categorylist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("products", $DetailTblVar)) {
				...
				if ($GLOBALS["products_grid"]->DetailView) {
					$GLOBALS["products_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($sub_category_view)) $sub_category_view = new csub_category_view();

// Page init
$sub_category_view->Page_Init();

// Page main
$sub_category_view->Page_Main();
...
var CurrentForm = fsub_categoryview = new ew_Form("fsub_categoryview", "view");

// Form_CustomValidate event
fsub_categoryview.Form_CustomValidate = 
...
fsub_categoryview.ValidateRequired = true;
<?php } else { ?>
fsub_categoryview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fsub_categoryview.Lists["x_category_id"] = {"LinkField":"x_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_category_name","","",""],"ParentFields":[],"ChildFields":["products x_category_id"],"FilterFields":[],"Options":[],"Template":""};
...
<?php
	foreach ($sub_category_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fsub_categoryview" id="fsub_categoryview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sub_category_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sub_category_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="sub_category">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($sub_category->scat_id->Visible) { // scat_id ?>
	<tr id="r_scat_id">
		<td><span id="elh_sub_category_scat_id"><?php echo $sub_category->scat_id->FldCaption() ?></span></td>
		<td data-name="scat_id"<?php echo $sub_category->scat_id->CellAttributes() ?>>
<span id="el_sub_category_scat_id">
<span<?php echo $sub_category->scat_id->ViewAttributes() ?>>
<?php echo $sub_category->scat_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sub_category->category_id->Visible) { // category_id ?>
	<tr id="r_category_id">
		<td><span id="elh_sub_category_category_id"><?php echo $sub_category->category_id->FldCaption() ?></span></td>
...
<?php echo $sub_category->category_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sub_category->scat_name->Visible) { // scat_name ?>
	<tr id="r_scat_name">
		<td><span id="elh_sub_category_scat_name"><?php echo $sub_category->scat_name->FldCaption() ?></span></td>
...
<?php echo $sub_category->scat_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sub_category->scat_description->Visible) { // scat_description ?>
	<tr id="r_scat_description">
		<td><span id="elh_sub_category_scat_description"><?php echo $sub_category->scat_description->FldCaption() ?></span></td>
		<td data-name="scat_description"<?php echo $sub_category->scat_description->CellAttributes() ?>>
<span id="el_sub_category_scat_description">
<span<?php echo $sub_category->scat_description->ViewAttributes() ?>>
<?php echo $sub_category->scat_description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sub_category->scat_picture->Visible) { // scat_picture ?>
	<tr id="r_scat_picture">
		<td><span id="elh_sub_category_scat_picture"><?php echo $sub_category->scat_picture->FldCaption() ?></span></td>
...
<?php echo ew_GetFileViewTag($sub_category->scat_picture, $sub_category->scat_picture->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php
$sub_category_view->Page_Terminate();
?>
